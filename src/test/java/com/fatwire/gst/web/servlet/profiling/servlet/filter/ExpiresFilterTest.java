...
public class ExpiresFilterTest extends TestCase {
    ...
    public void testParse15DPeriod() {
        final ExpiresFilter f = new ExpiresFilter();
        final int p = f.parsePeriod("15d", 60);
    ...
    public void testParse120Period() {
        final ExpiresFilter f = new ExpiresFilter();
        try {
            final int p = f.parsePeriod("120", 60);
    ...
    public void testParse5mPeriod() {
        final ExpiresFilter f = new ExpiresFilter();
        final int p = f.parsePeriod("5m", 60);
        assertEquals(5 * 60, p);
    }
